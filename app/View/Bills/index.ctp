...
<?php foreach ($bills as $bill): ?>
	<tr>
		...
		<td>
			<?php echo $this->Html->link($bill['Category']['title'], array('controller' => 'categories', 'action' => 'view', $bill['Category']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($bill['User']['username'], array('controller' => 'users', 'action' => 'view', $bill['User']['id'])); ?>
		</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $bill['Bill']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $bill['Bill']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bill['Bill']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $bill['Bill']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
